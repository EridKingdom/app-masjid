    ...
    <section data-bs-version="5.1" class="menu menu2 cid-ubOPQL1iFt" once="menu" id="menu-5-ubOPQL1iFt">
        ...
        <div class="sidebar" style="display: none;"> <!-- Adjust margin-top to match the navbar height, initially hidden -->
            <div class="profile-section">
                ...
                // Fetch the masjid name and image from the database
                $nama_masjid = '';
                $gambar_masjid = '';
                $id_masjid = null;
                if ($id_user) {
                ...
                ?>
                <img class="profile-img" src="/img/<?= htmlspecialchars($gambar_masjid, ENT_QUOTES, 'UTF-8'); ?>" alt="Profile Logo" style="height: 50px; width: 50px; border-radius: 50%;">
                <span class="profile-name"><?= htmlspecialchars($nama_masjid, ENT_QUOTES, 'UTF-8'); ?></span>

            </div>
            <a class="gambarlink" href="<?= base_url('/editProfile'); ?>">
                <img class="edit-profile-icon" src="<?= base_url(); ?>/assets/images/pensil.png" alt="Edit Profile">
            </a>
            <a class="nav-link link text-black text-primary display-4" href="<?= base_url('/profile'); ?>">Profile</a>
            <a class="nav-link link text-black text-primary display-4" href="<?= base_url('/buat-postingan'); ?>">Tambahkan Postingan</a>
            ...
            <div class="sidebar-logout">
                <a class="sidebar-login-tombol" href="#" onclick="confirmLogout()">Logout</a>
                <script>
