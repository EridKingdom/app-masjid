    ...
    <section data-bs-version="5.1" class="form5 cid-ubOSVY3BE5" id="form02-3">
        ...
        <section class="donasi-form">
            <div class="containerdonasi">
                <div class="card-body">
                    <form action="<?= base_url('/donasi-zakat-store'); ?>" method="post" enctype="multipart/form-data">
                        <h4>Formulir Donasi Zakat</h4>
                        <div class="form-group">
                            <label for="nama">Nama Lengkap atau Nama Organisasi</label>
                            <input type="text" class="form-control" id="nama" name="nama_donatur"
                                   placeholder="Masukkan Nama Lengkap" required>
                        </div>
                        <div class="form-group">
                            <label for="noTelp">Nomor Telepon</label>
                            <input type="tel" class="form-control" id="noTelp" name="ho_telp"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="nominal" name="nominal"
                                   placeholder="Nominal Donasi" required readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="rekening" name="rekening" value="<?= $masjid['no_rekening'] ?>" readonly
                                   disabled>
                        </div>
